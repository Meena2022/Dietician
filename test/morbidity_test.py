...
def test_1_get_allmorbidity():
    print("Test for Get All Morbidities")
    payload = {}
    headers = {}
...
def test_2_get_morbidityname():
    print("Test for Get Morbidity by MorbidityName")
    payload = {}
    headers = {}
...
def test_3_get_morbiditytestid():
    print("Test for Get Morbidity by MorbidityTestID")
    payload = {}
    headers = {}
...
#Post request for morbidity
def test_4_post_morbidity():
    print("Test for Post Morbidity")
...
# put request for morbidity
def test_5_put_morbidity():
       print("Test for Put Morbidity")
       csv_list = []
...
#Delete request for morbidity
def test_5_delete_morbidity():
    print("Test for Delete Morbidity")
    csv_list = []
